...
void CAN2_Configration(void)
{
    ...
    can_filter.CAN_FilterIdHigh = 0x0205<<5;
    can_filter.CAN_FilterIdLow = 0x0206<<5;
    can_filter.CAN_FilterMaskIdHigh =0x0204<<5;
    can_filter.CAN_FilterMaskIdLow = 0x0004<<5;
...
void CAN2_RX0_IRQHandler(void)
{
    ...
    if (CAN_GetITStatus(CAN2,CAN_IT_FMP0)!= RESET)
    {
        ...
        CAN2_Receive0Task(rx_message);
    }

}
/**********************************************************************************************************
*函 数 名: CAN2_RX1_IRQHandler
*功能说明: can2接收RX1中断，陀螺仪
*形    参: 无
*返 回 值: 无
**********************************************************************************************************/
void CAN2_RX1_IRQHandler(void)
{
    ...
    if (CAN_GetITStatus(CAN2,CAN_IT_FMP1)!= RESET)
    {
        ...
        CAN_Receive(CAN2, CAN_FIFO1, &rx_message);//CAN2参数传入结构体
        NewGyro_DataHandle(rx_message);
    }
}
